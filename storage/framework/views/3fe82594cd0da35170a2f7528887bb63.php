            ...
            <div class="group">
                ...
                <div class="mt-4">
                    <div class="flex justify-between">
                        ...
                        <p class="text-sm font-medium text-gray-900">$<?php echo e(number_format($product->sell_price, 2)); ?></p>
                    </div>
                    ...
                    <div class="mt-2">
                        <div class="flex items-center">
                            ...
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                ...
                                <?php endif; ?>
                            <?php endfor; ?>
                            <span class="ml-1 text-xs text-gray-500">(<?php echo e($product->reviews->count()); ?>)</span>
                        </div>
                        ...
                        <div class="mt-1 text-xs text-gray-500">
                            ...
                            <p>- <?php echo e($latestReview->user->name); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\stylesphere\resources\views/landing.blade.php ENDPATH**/ ?>