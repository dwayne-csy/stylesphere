...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-3">
                            <label for="image" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Profile Image')); ?></label>
                            <div class="col-md-6">
                                <input id="image" 
                                       type="file" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\stylesphere\resources\views/auth/register.blade.php ENDPATH**/ ?>